<%@page import="com.yakaja.vo.HotelVO2"%>
...
<table border=0 align="center">
	...
	<tr>
		<td colspan=8>
			<form action="getAllHotel_Sort.do" method="post">
				<!-- .do -->
				<!-- <form action="Telallview" method="post"> -->
				<div align="center">
					<select id="sel" name=sorter
						onchange="submit(this.options[this.selectedIndex].value)">
	...
	<tr>
		<td colspan=8>
			<form action="searchHotelWhere.do" method="post">
				...
				<!-- <form action="Telallview" method="post"> -->
				<div align="center">
					<a><input type="text" placeholder="지역 검색하기"
						onfocus="this.placeholder=''"
						onblur="this.placeholder='호텔위치 검색하기'" name="hotelWhere"></a> <a><input
						type="submit" value="검색"></a>
				</div>
			</form>
		</td>
	</tr>
 ...
 -->
				<div align="center">
					<a><input type="text" placeholder="호텔명 검색하기"
						onfocus="this.placeholder=''"
						onblur="this.placeholder='호텔이름 검색하기'" name="hotelName"></a> <a><input
						type="submit" value="검색"></a>
				</div>
			</form>
		</td>
	...
	<tr>
		...
		<td style='word-break:break-all;'>디럭스</td>
		<td style='word-break:break-all;'>스탠다드</td>
		<td style='word-break:break-all;'>싱글</td>
	...
	<c:forEach var="vo1" items="${alist1}">
		...
		<tr>
			...
			<td style="”word-break: break-all;"><a
				href="goHotel.do?hotel_name=${vo1.hotel_name}">${vo1.hotel_name}</a></td>
